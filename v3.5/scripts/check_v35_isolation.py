#!/usr/bin/env python3
"""Fail if executable v3.5 code imports or executes an older experiment tree."""
...
SAFETY_CHECKERS = {"check_v35_isolation.py", "check_environment.py"}
