...
def main() -> None:
    ...
    commands = [
        ...
        [python, "scripts/validate_phase_a5_smoke.py", "--help"],
        ...
        [python, "scripts/run_outer_semantic_confirmation_a5.py", "--help"],
        [python, "scripts/validate_outer_semantic_confirmation_a5.py", "--help"],
        [python, "scripts/prepare_test_trace_inputs.py", "--help"],
        [python, "scripts/cache_planner_traces.py", "--help"],
        [python, "scripts/validate_test_trace_cache.py", "--help"],
