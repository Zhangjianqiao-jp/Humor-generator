...
from humor_generator_v35.data.clustered import build_clustered_bridge_dataset
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "data/processed/latent_bridge_v35")
    parser.add_argument("--validation-fraction", type=float, default=0.10)
    parser.add_argument("--internal-test-fraction", type=float, default=0.15)
    parser.add_argument(
        "--tracked-manifest",
        type=Path,
