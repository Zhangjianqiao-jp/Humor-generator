...
from humor_generator_v3.homer.contracts import parse_conflicts
from humor_generator_v3.homer.prompts import caption_messages, conflict_messages, text_part
from humor_generator_v3.latent.bridges import TypedLatentBridge, mean_embedding_norm
from humor_generator_v3.qwen_backend import QwenBackend, model_device
from humor_generator_v3.training.losses import (
    sequence_log_probability,
    text_teacher_forward_kl,
    token_cross_entropy,
)
from humor_generator_v3.training.memory_safe import (
    assert_smoke_budget,
