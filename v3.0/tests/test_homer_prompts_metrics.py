...
from humor_generator_v3.homer.metrics import unbiased_pass_at_k
from humor_generator_v3.homer.prompts import CAPTION_SYSTEM, caption_messages, global_imagination_messages
